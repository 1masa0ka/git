...
if pass_st==1:
  st.sidebar.write('表示')
  slides_1 = st.sidebar.radio("テーマ選択",('1. 微細構造表面における凝縮水滴の凍結観察', '2. 機械学習を用いたPEFC触媒層の乾燥プロセス開発'))
  if slides_1[0]==1:
    slides_2 = st.sidebar.radio("スライド番号",('1. 背景・目的', '2. 背景・目的', '3. 実験方法(試料表面)','4. 実験方法(観察装置)','5. 結果(観察)','6. ','7. ','8. ','9. '))
  else:
